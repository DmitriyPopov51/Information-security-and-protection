...
a, b = 38, 95
print("Введенные числа -", a, ",", b)
print("Алгоритм Евклида:", euclidean_gcd(a, b))
print("Бинарный алгоритм Евклида:", binary_gcd(a, b))
print("Расширенный алгоритм Евклида:", extended_gcd(a, b)[0])
print("Расширенный бинарный алгоритм Евклида:", extended_binary_gcd(a, b)[0])
