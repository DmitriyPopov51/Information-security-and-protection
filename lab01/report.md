...
![cesar1](screenshots/img1.png){#fig:001 width=100%}

![cesar2](screenshots/img2.png){#fig:002 width=100%}
...
![cesar_out](screenshots/img3.png){#fig:003 width=100%}

Вторая программа для шифра Атбаш(@fig:004).

![atbash](screenshots/img4.png){#fig:004 width=100%}

Вывод работы программы (@fig:005)

![atbash_out](screenshots/img5.png){#fig:005 width=100%}
